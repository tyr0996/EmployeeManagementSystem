...
public class ProductSaveOrUpdateDialog extends VaadinSaveOrUpdateDialog {
    ...
    private static final String packingUnitXpath = "/html/body/vaadin-dialog-overlay/vaadin-form-layout/vaadin-combo-box[3]";
    ...
    @Getter
    private VaadinDropdownComponent packingUnitComponent;
    @Getter
    ...
    public void initWebElements() {
        ...
        packingUnitComponent = new VaadinDropdownComponent(getDriver(), By.xpath(packingUnitXpath));
    ...
    public void setAllComponents() {
        ...
        this.allComponent.add(packingUnitComponent);
