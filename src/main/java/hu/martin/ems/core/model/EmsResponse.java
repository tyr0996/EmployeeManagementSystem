...
public class EmsResponse {
    ...
    public interface Description {
        String SFTP_SENDING_ERROR = "EmsError happened when sending with SFTP";
        ...
        String FETCHING_CURRENCIES_FAILED = "EmsError happened while fetching exchange rates";
        ...
        String DOCUMENT_GENERATION_FAILED_CURRENCY_CONVERT_FAILED = "Document generation failed. EmsError happened while getting currency for exchanging";
    }
}
