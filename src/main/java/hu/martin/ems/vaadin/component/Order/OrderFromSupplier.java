...
public class OrderFromSupplier extends VerticalLayout implements BeforeEnterObserver {
    ...
    private void loadEditObject() {
        ...
        orderElementVOS = getOrderElementsBySupplier(editObject.getSupplier()).stream().map(OrderElementVO::new).collect(Collectors.toList());
        updateGridItems();
    ...
    private void init(PaginationSetting paginationSetting) {
        ...
        showPreviouslyOrderedElements.addValueChangeListener(event -> {
            ...
            orderElementVOS = suppliers.getValue() == null ?
                    new ArrayList<>() :
        ...
        saveButton.addClickListener(event -> {
            ...
            order.setSupplier(suppliers.getValue());
            ...
            if (orderElements.isEmpty()) {
                ...
                suppliers.setValue(suppliers.getEmptyValue());
    ...
    private void setupSuppliers() {
        ...
        switch (response.getCode()) {
            ...
            default:
                supplierList = null;
                logger.error("Supplier findAllError. [payment types] Code: {}, Description: {}", response.getCode(), response.getDescription());
                break;
        }
    }
