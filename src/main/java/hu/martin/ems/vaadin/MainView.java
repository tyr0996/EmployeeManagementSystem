...
public class MainView extends HorizontalLayout implements RouterLayout {
    ...
    public MainView() {
        ...
        addMenu(menuLayout, "Admin", "Munkavállalók", EmployeeCreate.class, EmployeeList.class);
        addMenu(menuLayout, "Admin", "Jogosultság", RoleCreate.class, RoleList.class);
        addMenu(menuLayout, "Admin", "Engedély", PermissionCreate.class, PermissionList.class);
        addMenu(menuLayout, "Admin", "Jogosultság-engedély összerendelés", RoleXPermissionCreate.class, null);
        addMenu(menuLayout, "Admin", "Kódtár", CodeStoreCreate.class, CodeStoreList.class);
